...
export default function Banner(props: Readonly<TitleWithTextElement>) {
  return (
    <div className="w-full sm:w-[95%] mb-10 relative">
      ...
      <p
        className="w-full h-fit sm:h-[14rem] p-16 pt-20 flex flex-row items-center 
        justify-center rounded-[75px] bg-[#ededed] text-3xl text-primary-darker"
      >
        {props.text}
      </p>
    </div>
